...
const LayoutContainer = () => {
  ...
  if (width / height > 0.48 && width / height < 1) {
    pageN = 30 + ((15 - height / 90))
  }

  if (width / height == 0.75) {
    pageN = 30 + ((10 - height / 230))
  }
  ...
  return (
    <div>
      <Parallax pages={29} className={classes.parallax}>
        ...
        {/* <ParallaxLayer factor={6} offset={5.3} speed={.4} style={{
          // #c2c0c0
          backgroundImage: 'linear-gradient(to bottom, #ffffff, transparent)',
          // height: '80%'
        }} />
        <ParallaxLayer factor={1.4} offset={5.3} speed={.4} style={{
          width: '100%',
        ...
        {/*  >Md */}
        <Hidden mdDown>
          <ParallaxLayer factor={10} offset={5.5} speed={.2}
            style={{
              width: '85%',
              display: 'block',
              paddingLeft: '5%',
        ...
        {/* Footer */}
        <ParallaxLayer factor={1} offset={28} speed={.7} className={classes.myName}>
          <Footer />
        </ParallaxLayer>
